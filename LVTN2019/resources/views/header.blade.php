<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 180 Cao Lỗ, Phường 4, Quận 8, TPHCM</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0364322550</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/assets/dest/images/logohang.png" width="250px" alt=""></a>
				</div>
